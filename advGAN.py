...
class AdvGAN_Attack:
    ...
    def train_batch(self, x, labels):
        ...
        for i in range(self.n_steps_G):
            ...
            onehot_labels = torch.eye(self.n_labels, device=self.device).type(logits_model.type())[labels.long()]
            ...
            target_class_prob = torch.max((1 - onehot_labels) * probs_model - onehot_labels * 10000, dim=1)[0]
